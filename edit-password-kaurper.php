		...
		<div class="content-wrapper">
			<div class="content-header row"></div>
					<div class="content-body"><!-- Stats -->
							...
							<h3 class="panel-title"> <i class="icon-users"></i> Ubah Password KAUR Perencanaan</h3>
							<p class="panel-subtitle">Halaman untuk mengubah password KAUR Perencanaan</p>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="" enctype="multipart/form-data" action="update-password-kaurper.php" method="post">
