...
?>
	<div class="app-content content">
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="panel-title"> <i class="icon-envelope-letter"></i> Proposal Kepala Desa</h3>
										<p class="panel-subtitle">Halaman untuk mengelola proposal pengajuan dari Kepala Desa</p>
									</div>
												...
												<table class="table table-striped table-bordered base-style">
													<thead>
															<tr>
																...
																<th>Tanggal Diterima Kepala Desa</th>
																<th>Lampiran</th>
																<th>#</th>
																<th>#</th>
															</tr>
													...
													<tbody>
														<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status = '3' ORDER BY tanggal_proposal ASC");
														while($q = mysqli_fetch_array($qy)) { ?>
															<tr>
																<td><?= $no; ?></td>
																<td>
																<?php
																		if ($q['status_baca_bendes1']==1){
																...
																<td>
																	...
																	<button type="button" onClick="terima(<?php echo $q['id_proposal']; ?>)" class="btn btn-warning" data-toggle="tooltip" title="Cairkan Dana">
																			<i class="fa fa-money"></i>
																			Cairkan Dana
																			<script language="javascript">
																				function terima(id_proposal)
																				{
																				if(confirm("Apakah Anda yakin ingin mencairkan dana untuk pekerjaan ini?")){
																				window.location.href='cairkan-dana-bendes.php?id_proposal='+id_proposal;
																				return true;
																				}
																				} 
																			</script>
												...
												<div class="modal fade text-left" id="detail<?php echo $q['id_proposal']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
																<div class="modal-dialog" role="document">
																	...
																	<div class="modal-body">
																		...
																		<tr>
																		<th width="50%" style=border:0;>Tanggal Diterima Kepala Desa</th>
																		<td width="50%" style=border:0;><?= $q['tanggal_acc']; ?></td>
																		</tr>
																		<tr>
															...
															<div class="modal fade text-left" id="tolak<?php echo $q['id_proposal']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel35" aria-hidden="true">
																<div class="modal-dialog modal-large" role="document">
																	...
																	<div class="modal-content">
																		...
																		<div class="panel-body">
																			<form class="" enctype="multipart/form-data" action="tolak-pencairan-bendes.php" method="post">
																				<div class="modal-body">
		...
		<?php mysqli_query($connect,"UPDATE proposal_pengajuan SET status_baca_bendes1=0 WHERE status_baca_bendes1=1");?>
