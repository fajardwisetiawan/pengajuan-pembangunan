							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="panel-title"> <i class="icon-envelope-letter"></i> Proposal Diterima Kepala Desa</h3>
										<p class="panel-subtitle">Halaman untuk menampilkan proposal pengajuan yang diterima oleh Kepala Desa</p>
									</div>
