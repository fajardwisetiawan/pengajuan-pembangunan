											...
											<div class="table-responsive">
												...
												<table class="table table-striped table-bordered base-style">
													...
													<tbody>
														<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status = '-2' AND untuk = 'KAUR Perencanaan'");
														while($q = mysqli_fetch_array($qy)) { ?>
															<tr>
																...
																<td class="text-center">
																	<form class="" action="perbaiki-proposal-kaurper" method="post">
																...
																<td>
																	<button type="button" onClick="hapus(<?php echo $q['id_proposal']; ?>)" class="btn btn-danger" data-toggle="tooltip" title="Hapus">
																		...
																		<script language="javascript">
																			...
																			window.location.href='hapus-proposal-ditolak-kaurper.php?id_proposal='+id_proposal+'';
																			return true;
																			}
																			} 
																		</script>
