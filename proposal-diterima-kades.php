...
?>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="panel-title"><i class="icon-check"></i> Proposal Diterima</h3>
										<p class="panel-subtitle">Halaman untuk mengelola proposal pekerjaan yang diterima oleh kepala desa</p>
									</div>
	...
	<?php mysqli_query($connect,"UPDATE proposal_pengajuan SET status_baca_kades2=0 WHERE status_baca_kades2=1");?>
