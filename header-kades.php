...
<head>
    ...
    <title>E-PROMI - Kepala Desa | Desa Kedungbenda, Kecamatan Kemangkon, Kabupaten Purbalingga</title>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <a class="dropdown-item" href="edit-user-kades"><i class="ft-user"></i> Kelola Akun</a>
                <a class="dropdown-item" href="edit-password-kades"><i class="ft-settings"></i> Ubah Password</a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" navigation-header"><span>KEPALA DESA</span><i class=" ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="General"></i>
          </li>
          <li class=" nav-item"><a class="update-pro" href="dashboard-kades" title="Dashboard"><i class="icon-speedometer"></i><span class="menu-title" data-i18n="">Dashboard</span></a>
          </li>
          <li class="">
	          <a href="proposal-kades" title="Proposal Sekertaris Desa"><i class="icon-envelope-letter"></i><span class="menu-title" data-i18n="">Proposal Sekertaris Desa</span></a>
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-check"></i><span class="menu-title" data-i18n="">Konfirmasi Proposal</span></a>
            <ul class="menu-content">
				      <li><a href="proposal-diterima-kades" class="notification-item">Proposal Diterima</a>
				      </li>
              <li><a href="proposal-ditolak-kades" class="notification-item">Proposal Ditolak</a>
				      </li>
            </ul>
          </li>
          <!-- <li class="">
	          <a href="rpjm-des" title="RPJM Des"><i class="ft-clipboard"></i><span class="menu-title" data-i18n="">RPJM Des</span></a>
          </li> -->
          <li class=" nav-item"><a href="#"><i class="fa fa-building-o"></i><span class="menu-title" data-i18n="">Pembangunan</span></a>
            <ul class="menu-content">
				      <li><a href="daftar-pencairan-dana-kades" title="Daftar Pencairan Dana" class="notification-item">Daftar Pencairan Dana</a>
				      </li>
              <li><a href="riwayat-pembangunan-terlaksana-kades" title="Riwayat Pembangunan Terlaksana" class="notification-item">Riwayat Pembangunan Terlaksana</a>
              </li>
              <li><a href="konfirmasi-pembangunan" title="Konfirmasi Pembangunan" class="notification-item">Konfirmasi Pembangunan</a>
				      </li>
            </ul>
          </li>
          <li class=" nav-item"><a href="#"><i class="fa fa-wrench"></i><span class="menu-title" data-i18n="">Tahap Pembangunan</span></a>
            <ul class="menu-content">
				      <li><a href="pembangunan-belum-dikerjakan-kades" class="notification-item">Belum Dikerjakan</a>
				      </li>
              <li><a href="pembangunan-dalam-proses-kades" class="notification-item">Dalam Proses</a>
				      </li>
              <li><a href="pembangunan-selesai-pengerjaan-kades" class="notification-item">Selesai Pengerjaan</a>
				      </li>
            </ul>
          </li>
          <li class="">
	          <a href="pencairan-dana-ditolak" title="Pencairan Dana Ditolak"><i class="icon-ban"></i><span class="menu-title" data-i18n="">Pencairan Dana Ditolak</span></a>
          </li>
          <li class="">
	          <a href="proposal-pending-kades" title="Proposal Pending KADES"><i class="fa fa-exclamation"></i><span class="menu-title" data-i18n="">Proposal Pending KADES</span></a>
          </li>
        </ul>
      </div>
    </div>