							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										...
										<p class="panel-subtitle">Halaman untuk mengelola akun KAUR Perencanaan</p>
									</div>
									<div class="panel-body">
										<div class="row">
											<div class="col-md-12">
												<form class="" enctype="multipart/form-data" action="update-user-kaurper.php" method="post">
