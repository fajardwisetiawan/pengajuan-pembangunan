...
?>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="panel-title"> <i class="fa fa-building-o"></i> Daftar Pembangunan</h3>
										<p class="panel-subtitle">Halaman berisi daftar pembangunan yang telah dicairkan dananya dan belum terlaksana</p>
									</div>
											...
											<div class="table-responsive">
												...
												<table class="table table-striped table-bordered base-style">
													...
													<tbody>
														<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status = '4' ORDER BY tanggal_proposal ASC");
														while($q = mysqli_fetch_array($qy)) { ?>
															<tr>
																<td><?= $no; ?></td>
																<td>
																<?php
																		if ($q['status_baca_kaurpem']==1){
														...
														<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status = '4'");
														while($q = mysqli_fetch_array($qy)) { ?>
														<!-- Modal -->
															...
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		<tr>
																		<th width="50%" style=border:0;>Tanggal Pencairan Dana</th>
																		<td width="50%" style=border:0;><?= $q['tanggal_pencairan']; ?></td>
																		</tr>
																		<tr>
	...
	<?php mysqli_query($connect,"UPDATE proposal_pengajuan SET status_baca_kaurpem=0 WHERE status_baca_kaurpem=1");?>
