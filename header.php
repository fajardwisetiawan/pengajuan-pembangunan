...
<head>
    ...
    <title>E-PROMI - Admin | Desa Kedungbenda, Kecamatan Kemangkon, Kabupaten Purbalingga</title>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <a class="dropdown-item" href="kelola-admin"><i class="ft-user"></i> Kelola Admin</a>
                <a class="dropdown-item" href="edit-password"><i class="ft-settings"></i> Ubah Password</a>
                <div class="dropdown-divider"></div><a class="dropdown-item" href="keluar"><i class="ft-power"></i> Logout</a>
                </div>
              </li>
            </ul>
          </div>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" navigation-header"><span>ADMIN</span><i class=" ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="General"></i>
          </li>
          <li class=" nav-item"><a class="update-pro" href="dashboard-admin" title="Dashboard"><i class="icon-speedometer"></i><span class="menu-title" data-i18n="">Dashboard</span></a>
          </li>
          <li class="">
	          <a href="perangkat-desa" title="Perangkat Desa"><i class="icon-users"></i><span class="menu-title" data-i18n="">Perangkat Desa</span></a>
          </li>
          <li class=" nav-item"><a href="#"><i class="icon-settings"></i><span class="menu-title" data-i18n="">Pengaturan</span></a>
            <ul class="menu-content">
				      <li><a href="jabatan" class="notification-item">Jabatan</a>
				      </li>
              <li><a href="sub-jabatan" class="notification-item">Sub-jabatan</a>
				      </li>
            </ul>
		      </li>
        </ul>
