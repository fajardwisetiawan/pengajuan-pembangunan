											...
											<div class="table-responsive">
												...
												<table class="table table-striped table-bordered base-style">
													...
													<tbody>
														<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status = '2' AND tanggal_proposal <= ADDDATE(NOW(), -14) AND tanggal_proposal < NOW()");
															...
															<tr>
																...
																<td>																	
																	<div class="btn-group" role="group" aria-label="Basic example">
																		...
																		<a href="tampil2.php?id=<?php echo $q['lampiran1'] ?>" class="btn btn-pink" title="Download Lampiran Proposal"><i class="fa fa-cloud-download"></i> Lampiran Proposal</a>
																	</div>
																</td>													
																<td>
																...
																<td>
																		<button type="button" onClick="hapus(<?php echo $q['id_proposal']; ?>)" class="btn btn-danger" data-toggle="tooltip" title="Hapus">
																			...
																			<script language="javascript">
																				...
																				window.location.href='hapus-proposal-pending-kades.php?id_proposal='+id_proposal+'';
																				return true;
																				}
																				} 
																			</script>
