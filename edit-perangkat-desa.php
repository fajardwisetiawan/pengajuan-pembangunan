<?php
include("header.php");
$qy = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM perangkat_desa WHERE id_perangkat_desa = '$_POST[id]'"));
?>
			...
			<div class="content-header row"></div>
					<div class="content-body"><!-- Stats -->
						...
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="" enctype="multipart/form-data" action="update-perangkat-desa.php" method="post">
										<div class="modal-body">
												...
												<div class="form-group">
													...
													<input type="text" class="form-control input-md" name="password" value="<?= $qy['password'] ?>" placeholder="Password" required>
												</div>
												<div class="form-group">
