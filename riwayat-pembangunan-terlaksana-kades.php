										...
										<div class="row">
											...
											<div class="table-responsive">
												...
												<table class="table table-striped table-bordered base-style">
													...
													<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status = '5' ORDER BY tanggal_proposal DESC");
														while($q = mysqli_fetch_array($qy)) { ?>
															<tr>
																...
																<td class="text-center">
																	<form class="" action="rincian-biaya2" method="get">
															...
															<div class="modal-dialog" role="document">
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		...
																		<tr>
																		<th width="50%" style=border:0;>Tanggal Mulai Pelaksanaan</th>
																		<td width="50%" style=border:0;><?= $q['tanggal_mulai_pelaksanaan']; ?></td>
																		</tr>
																		<tr>
																		<th width="50%" style=border:0;>Tanggal Mulai Pelaksanaan</th>
																		<td width="50%" style=border:0;><?= $q['tanggal_selesai_pelaksanaan']; ?></td>
																		</tr>
																		<tr>
