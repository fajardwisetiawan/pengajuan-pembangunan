		...
		<div class="content-wrapper">
			<div class="content-header row"></div>
					<div class="content-body"><!-- Stats -->
							...
							<h3 class="panel-title"> <i class="icon-envelope"></i> Surat Bendahara Desa</h3>
							<p class="panel-subtitle">Halaman untuk mengelola surat pengajuan dari Bendahara Desa</p>
						</div>
								...
								<div class="table-responsive">
									...
									<table class="table table-striped table-bordered base-style">
										...
										<tbody>
											<?php
											$no = 1;
											$qy = mysqli_query($connect, "SELECT * FROM surat_pengajuan WHERE status = '4'");
											while($q = mysqli_fetch_array($qy)) { ?>
												<tr>
													...
													<div class="btn-group" role="group" aria-label="Basic example">
														<button type="button" onClick="terima(<?php echo $q['id_surat']; ?>)" class="btn btn-info" data-toggle="tooltip" title="Terima">
																<i class="icon-check"></i>
																Terima
																<script language="javascript">
																	function terima(id_surat)
																	{
																	if(confirm("Apakah Anda yakin ingin menerima surat ini?")){
																	window.location.href='terima-pengajuan-kaurper.php?id_surat='+id_surat;
																	return true;
																	}
																	} 
																</script>
														</button>
														<button type="button" onClick="tolak(<?php echo $q['id_surat']; ?>)" class="btn btn-danger" data-toggle="tooltip" title="Tolak">
																<i class="icon-ban"></i>
																Tolak
																<script language="javascript">
																	function tolak(id_surat)
																	{
																	if(confirm("Apakah Anda yakin ingin menolak surat ini?")){
																	window.location.href='tolak-pengajuan-kaurper.php?id_surat='+id_surat;
																	return true;
																	}
																	} 
																</script>
