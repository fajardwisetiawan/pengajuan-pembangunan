...
// $kaurper = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM perangkat_desa WHERE id_perangkat_desa = '$_SESSION[id_perangkat_desa]'"));
?>
		...
		<div class="content-wrapper">
			<div class="content-header row"></div>
					<div class="content-body"><!-- Stats -->
							...
							<h3 class="panel-title"> <i class="icon-users"></i> Ubah Password KAUR Pembangunan</h3>
							<p class="panel-subtitle">Halaman untuk mengubah password KAUR Pembangunan</p>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="" enctype="multipart/form-data" action="update-password-kaurpem.php" method="post">
