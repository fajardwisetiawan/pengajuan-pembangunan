							...
							<div class="col-12">
								<div class="card">
									...
									<div class="panel-body">
										<div class="row">
											<div class="col-md-12">
												<form class="" enctype="multipart/form-data" action="simpan-perbaikan-sekdes.php" method="post">
													<div class="modal-body">
															...
															<div class="form-group">
																...
																<input type="text" class="form-control input-md" name="judul_kegiatan" value="<?= $qy['judul_kegiatan'] ?>" placeholder="Judul Kegiatan" required readonly>
															</div>
															<div class="form-group">
																<label class="nk-label">Deskripsi Kegiatan</label>
																<textarea class="form-control" name="deskripsi_kegiatan" id="descTextarea" rows="3" placeholder="Silahkan Anda Masukkan Deskripsi Kegiatan" readonly><?= $qy['deskripsi_kegiatan'] ?></textarea>
															</div>
															<div class="form-group">
																<label>Lampiran Proposal</label>
																<br>
																<label class="fancy-checkbox">
																<input type="checkbox"  id="toggle4" name="ubah_proposal">
																<span>Ubah Lampiran</span>
																</label>
																<br>
																<label class="nk-label">
																<input type="file" accept="file_extension" name="lampiran2" class="form-control" id="lampiran2" required disabled
