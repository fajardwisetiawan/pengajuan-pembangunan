...
// $kades = mysqli_fetch_array(mysqli_query($connect, "SELECT * FROM perangkat_desa WHERE username = '$_SESSION[username]'"));
?>
		...
		<div class="content-wrapper">
			<div class="content-header row"></div>
					<div class="content-body"><!-- Stats -->
							...
							<h3 class="panel-title"> <i class="icon-users"></i> Ubah Password Kepala Desa</h3>
							<p class="panel-subtitle">Halaman untuk mengubah password Kepala Desa</p>
						</div>
						<div class="panel-body">
							<div class="row">
								<div class="col-md-12">
									<form class="" enctype="multipart/form-data" action="update-password-kades.php" method="post">
