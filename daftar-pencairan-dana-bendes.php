...
?>
							...
							<div class="col-12">
								<div class="card">
									<div class="card-header">
										<h3 class="panel-title"><i class="fa fa-money"></i> Daftar Pencairan Dana</h3>
										<p class="panel-subtitle">Halaman untuk menampilkan pembangunan yang telah dicairkan dananya</p>
									</div>
											...
											<div class="table-responsive">
												...
												<table class="table table-striped table-bordered base-style">
													...
													<tbody>
														<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status1 = '1' ORDER BY tanggal_proposal ASC");
														while($q = mysqli_fetch_array($qy)) { ?>
															<tr>
																<td><?= $no; ?></td>
																<td>
																<?php
																		if ($q['status_baca_bendes2']==1){
												...
												<?php
														$no = 1;
														$qy = mysqli_query($connect, "SELECT * FROM proposal_pengajuan WHERE status1 = '1'");
														while($q = mysqli_fetch_array($qy)) { ?>
												<!-- Modal -->
	...
	<?php mysqli_query($connect,"UPDATE proposal_pengajuan SET status_baca_bendes2=0 WHERE status_baca_bendes2=1");?>
