...
<head>
    ...
    <title>E-PROMI - Sekertaris Desa | Desa Kedungbenda Kecamatan Kemangkon Kabupaten Purbalingga</title>
        ...
        <div class="navbar-container content">
          <div class="collapse navbar-collapse" id="navbar-mobile">
            ...
            <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                ...
                <a class="dropdown-item" href="edit-user-sekdes"><i class="ft-user"></i> Kelola Akun</a>
                <a class="dropdown-item" href="edit-password-sekdes"><i class="ft-settings"></i> Ubah Password</a>
    ...
    <div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
      <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
          <li class=" navigation-header"><span>SEKERTARIS DESA</span><i class=" ft-minus" data-toggle="tooltip" data-placement="right" data-original-title="General"></i>
          </li>
          <li class=" nav-item"><a class="update-pro" href="dashboard-sekdes" title="Dashboard"><i class="icon-speedometer"></i><span class="menu-title" data-i18n="">Dashboard</span></a>
          </li>
          <li class="">
	          <a href="proposal-sekdes" title="Proposal KAUR Perencanaan"><i class="icon-envelope-letter"></i><span class="menu-title" data-i18n="">Proposal KAUR Perencanaan</span></a>
          </li>
          <li class=" nav-item"><a href="#"><i class="fa fa-spinner"></i><span class="menu-title" data-i18n="">Tahap Pengajuan</span></a>
            <ul class="menu-content">
				      <li><a href="proposal-terkirim-sekdes" title="Proposal Terkirim" class="notification-item">Proposal Terkirim</a>
				      </li>
              <li><a href="proposal-diterima-oleh-kades" title="Diterima Kepala Desa" class="notification-item">Diterima Kepala Desa</a>
				      </li>
              <li><a href="proposal-ditolak-pada-sekdes" title="Ditolak Kepala Desa" class="notification-item">Ditolak Kepala Desa</a>
				      </li>
            </ul>
          </li>
          <!-- <li class="">
	          <a href="proposal-terkirim-sekdes" title="Proposal Terkirim Sekertaris Desa"><i class="icon-envelope"></i><span class="menu-title" data-i18n="">Proposal Terkirim SEKDES</span></a>
          </li>
          <li class="">
	          <a href="proposal-ditolak-pada-sekdes" title="Proposal Ditolak Kepala Desa"><i class="icon-ban"></i><span class="menu-title" data-i18n="">Proposal Ditolak KADES</span></a>
          </li> -->
          <li class="">
	          <a href="proposal-pending-sekdes" title="Proposal Pending Sekdes"><i class="fa fa-exclamation"></i><span class="menu-title" data-i18n="">Proposal Pending Sekdes</span></a>
          </li>
          <!-- <li class=" nav-item"><a href="#"><i class="icon-check"></i><span class="menu-title" data-i18n="">Konfirmasi Proposal</span></a>
            <ul class="menu-content">
				      <li><a href="proposal-diterima-sekdes" class="notification-item">Proposal Diterima</a>
				      </li>
              <li><a href="proposal-ditolak-sekdes" class="notification-item">Proposal Ditolak</a>
				      </li>
            </ul>
		      </li> -->
        </ul>
