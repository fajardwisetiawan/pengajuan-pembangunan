...
$excel->getProperties()->setCreator('Ajang')
					   ...
					   ->setTitle("RPJM DES")
					   ->setSubject("RPJM DES")
					   ->setDescription("Template RPJM DES")
					   ->setKeywords("RPJM DES");
...
$excel->setActiveSheetIndex(0)->setCellValue('A1', "RANCANGAN RPJM DES"); // Set kolom A1 dengan tulisan "DATA SISWA"
...
$excel->getActiveSheet(0)->setTitle("Template RPJM Des");
$excel->setActiveSheetIndex(0);

// Proses file excel
header('Content-Type: application/vnd.openxmlformats-officedocument.spreadsheetml.sheet');
header('Content-Disposition: attachment; filename="Template RPJM Des".xlsx"'); // Set nama file excel nya
