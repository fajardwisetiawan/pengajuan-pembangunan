...
$qy=mysqli_fetch_array(
	mysqli_query($connect, "SELECT * FROM perangkat_desa WHERE id_perangkat_desa='$id'"));
if ($jabatan==""){
	$jabatan=$qy['jabatan'];
}

if ($subjabatan==""){
	$subjabatan=$qy['subjabatan'];
}
if (isset($_POST['ubah_foto'])) {
    ...
    mysqli_query($connect, "UPDATE perangkat_desa SET
      id_perangkat_desa = '$id',
      nama = '$nama',
      username = '$username',
      password = '$password', 
			jabatan = '$jabatan',
			subjabatan = '$subjabatan',
      foto = '$fotobaru' WHERE id_perangkat_desa = '$id'");

      echo '<script language="javascript">swal("Update berhasil!", "Data Perangkat Desa terupdate", "success").then(() => { window.location="perangkat-desa"; });</script>';
	...
	password = '$password', 
	jabatan = '$jabatan',
	subjabatan = '$subjabatan' WHERE id_perangkat_desa = '$id'");

    echo '<script language="javascript">swal("Update berhasil!", "Data Asisten terupdate", "success").then(() => { window.location="perangkat-desa"; });</script>';
